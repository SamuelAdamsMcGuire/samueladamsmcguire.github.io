...
<div style="display:flex;flex-direction:column;gap:0.6em;margin-top:0.5em;font-size:0.8em;">
  ...
  <div style="display:flex;gap:0.7em;">
    ...
    <div style="flex:1;background:#2a1a1a;border:1px solid #6a3a3a;border-radius:8px;padding:0.45em 0.8em;">
      <div style="color:#ff6b6b;font-weight:bold;margin-bottom:0.15em;">❌ Fixed 3-month average</div>
      <div style="color:#ccc;font-size:0.88em;line-height:1.35;">Always the last 3 months — same rate whether forecasting tomorrow or in 6 months. When operations change, the rate is wrong until the window catches up.</div>
    </div>
    <div style="flex:1;background:#2a1a1a;border:1px solid #6a3a3a;border-radius:8px;padding:0.45em 0.8em;">
      <div style="color:#ff6b6b;font-weight:bold;margin-bottom:0.15em;">❌ No schedule = no forecast</div>
      <div style="color:#ccc;font-size:0.88em;line-height:1.35;">Dependence on the schedule numbers. Any abence of flights short or long term lead to no forecast</div>
    </div>
    <div style="flex:1;background:#2a1a1a;border:1px solid #6a3a3a;border-radius:8px;padding:0.45em 0.8em;">
      <div style="color:#ff6b6b;font-weight:bold;margin-bottom:0.15em;">❌ Aircraft swaps ignored</div>
      <div style="color:#ccc;font-size:0.88em;line-height:1.35;">Aircraft swaps are common. F+ applies the same rate regardless of what actually flew.</div>
    </div>
  </div>
</div>
```
